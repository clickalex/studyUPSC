# Ethics, Integrity & Aptitude — Detailed Notes (Foundations)

> **Syllabus slot:** GS 4 (Mains) · Ethics & human interface, attitude, aptitude, emotional intelligence, moral thinkers (Socrates → Gandhi → moderns), conscience, accountability, codes of ethics, work culture
> **Marking logic:** high abstract-to-application conversion. Every topic below closes with a *civil-service application* line — use that pattern.
...
## 2. Attitude — structure, function & formation

- ABC model: **Affect, Behaviour, Cognition**.
- Functions: knowledge; ego-defensive; value-expressive; instrumental/adaptive (Katz).
...
- Dangers: emotionally-manipulative decision capture (persuasion asymmetry in committee politics); burnout — institutional buffers (peer circles, grievance cells, periodic rotations).

## 5. Moral thinkers — compact canon for citation

### Western
- **Socrates**: examined life; conscience over group consensus ("unexamined life is not worth living").
- **Plato**: philosopher-king ideal; justice as harmony of parts (Republic); cave allegory for false knowledge.
- **Aristotle**: virtue ethics — virtue as habituated mean between extremes; **phronesis** (practical wisdom) crucial for administration.
- **Kant**: categorical imperative (act only on principles universalisable; treat humanity as end not means); duty over inclination; good will.
- **Bentham/Mill**: utilitarianism — greatest happiness; Mill's refinements (qualitative pleasures, harm principle, liberal tolerance).
...
- **Mahavira**: anekantavada (pluralism — multi-view ethics), ahimsa rigor.
...
- **Accountability**: answerability → sanction; types: hierarchical, legal, professional, political, social. RTI 2005 ↔ accountability mechanism; social audit (MGNREGA → CPA).
...
- **Codes framework**:
  ...
  - **Nolan Principles (1994 UK)**: **selflessness, integrity, objectivity, accountability, openness, honesty, leadership** — mandatory memorisation for GS-4.

## 7. Probity & governance bridges
- Probity elements: integrity in procurement (PPP codes), conflict-of-interest disclosures (2008 rules), citizen charters (2nd ARC, Citizen's Charter Bill drafts), Lokpal & Lokayuktas Act 2013 (appointments since 2023-24 refresh); CVC + CBI + ED functional independence debates (Vineet Narain guidelines).
- Public trust erosion markers: NCRB crime statistics, corruption perception indices (TII — India ~93rd of 180 in 2024 CPI — bracket-check), RTI dilution critiques (2019 amendment).
- Corruption typologies: petty, grand, systemic; forms: bribery, nepotism, regulatory capture, rent-seeking, cronyism, collusion.

## 8. PYQ anchors (foundation-side)
- Define EI + ways to enhance for administrator.
- Values formation & role of institutions—"accountability ensures ethical conduct" tension.
- Thinkers: Aristotle's phronesis applied to district administration (2020-ish pattern).
- Nolan principles application to procurement decision-making.
- Conscience-over-orders problem (Arendt + civil disobedience angle).

## 9. Sources & Further Reading
- 2nd ARC Report — *Ethics in Governance* (Vol IV)
- MNC readings on applied ethics (Manu — no — Just teacher PDFs? skip)
- Goleman; Salovey-Mayer papers (abstract-level)
- 2nd ARC "Ethics in Governance" chapter summaries + ARC "Unlocking human capital"
- PYQ practice: see `pyqs/ethics-foundations-pyqs.md` in this folder
